...
"""
TYBER ID – Windows-адаптированная версия
"""
...
# Пытаемся импортировать colorama, если нет – отключаем цвета
try:
...
# Цветной вывод (если colorama есть)
...
║              {Fore.WHITE}{Style.BRIGHT}WINDOWS EDITION{Style.RESET_ALL}{Fore.BLUE}                         ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝{Style.RESET_ALL}
"""
    print(banner)
...
# ========== Ввод данных с улучшенной обработкой ==========
def get_vk_token():
    ...
    # Дополнительная очистка: удаляем возможные невидимые символы
