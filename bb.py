...
"""
TYBER ID – захват доменов ВК + Telegram-уведомления (максимальная скорость)
Версия: с встроенным токеном, сохранением в файл, английские уведомления
"""
...
║              {Fore.WHITE}{Style.BRIGHT}максимальная скорость{Style.RESET_ALL}{Fore.BLUE}                    ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝{Style.RESET_ALL}
"""
    print(banner)
...
# Таймауты минимальны для максимальной скорости
CHECK_TIMEOUT = 0.2          # для проверки домена
CAPTURE_TIMEOUT = 0.3        # для захвата домена
...
# ========== VK монитор с максимальной скоростью ==========
class VKMonitor:
    def __init__(self, token):
        self.token = token
        self.session = requests.Session()
        # Отключаем retry для максимальной скорости
    ...
    def _api_request(self, method, url, params=None, data=None, timeout=0.2):
        params = params or {}
